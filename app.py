...
try:
    ...
    covid_model = pickle.load(open(os.path.join(model_dir, "covid.pkl"), "rb"))  
    # genhealth_model = pickle.load(open(os.path.join(model_dir, "genhealth.pkl"), "rb")) 
    sleephealth_model = pickle.load(open(os.path.join(model_dir, "sleep2.pkl"), "rb"))  
...
def predict_sleephealth():
    ...
    try:
        ...
        predicted_label = sleephealth_model.predict(features)[0]  
